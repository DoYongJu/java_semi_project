...
<body>
	<div class="container-sm m-5">
		...
		<div class="row" id="divLogin">
			...
			<div class="col-sm-10">
				<form id="submit" method="post" action="?action=doFindPWD">
				<br><br><br><br>
					<h1 style="text-align: center; font-weight: bold;">Find PWD</h1><br>

					<div class="form-floating mb-3">
						<input type="text" class="form-control" name="username" 
							id="id" placeholder="Id"> <label for="user_name">가입한 아이디를 입력해주세요.</label>
					</div>
				...
				style="color: #FF7493; font-weight: bold;" href="?action=findID">아이디 찾기</a>
				<a class="link-offset-2 link-underline link-underline-opacity-0 me-3"
