...
<body>
	<div class="container-sm m-5 mx-auto">
		...
		<table class="table table-hover">
			...
			<c:forEach var="list" items="${lists}" varStatus="status">
				<tr>
					...
					<td><fmt:formatDate value="${list[3]}" pattern="yyyy-MM-dd" /></td>
		...
		<form class="row g-3">
			<div class="col-auto">
				<select class="form-select form-select"
					aria-label="Large select example" name="Type" id="Type">
			...
			<div class="col-auto">
				<div class="input-group">
					<input type="text" class="form-control"
						...
						aria-describedby="button-addon2" name="Content" id="Content" value="">
					<button class="btn btn-outline-secondary" type="button"
						id="button-addon80">검색</button>
				</div>
			</div>
				<div class="col-auto">
		...
		<form id="selectList"  method ="post" action="?action=community" name="selectList">
			<input type ="hidden" value="" name="searchType" id ="hiddenInput1">
			<input type ="hidden" value="" name="searchContent" id ="hiddenInput2">
		</form>
		</div>
		<script src="/Diet/JS/community.js"></script>
